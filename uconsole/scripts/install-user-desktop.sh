...
BIN_SOURCE="${UCONSOLE_DIR}/bin/agent-buddy-wayland"
ICON_SOURCE="${UCONSOLE_DIR}/assets/agent-buddy-uconsole.png"
DESKTOP_TEMPLATE="${SCRIPT_DIR}/agent-buddy-uconsole.desktop.template"
BIN_TARGET="${HOME}/.local/bin/agent-buddy-uconsole"
APP_DIR="${HOME}/.local/share/applications"
ICON_DIR="${HOME}/.local/share/icons/hicolor/1024x1024/apps"
ICON_TARGET="${ICON_DIR}/agent-buddy-uconsole.png"
DESKTOP_ID="github.com.vxider.agent-buddy.uconsole"
DESKTOP_FILE="${APP_DIR}/${DESKTOP_ID}.desktop"
LEGACY_DESKTOP_FILE="${APP_DIR}/agent-buddy-uconsole.desktop"
DESKTOP_COPY="${HOME}/Desktop/agent-buddy-uconsole.desktop"
