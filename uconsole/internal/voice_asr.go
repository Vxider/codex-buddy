...
func loadVoiceASRConfig() voiceASRConfig {
	...
	cfg := voiceASRConfig{
		...
		VoiceGlossaryFile:       expandHome(firstNonEmptyText(values["VOICE_GLOSSARY_FILE"], "~/.config/agent-buddy/voice-glossary.txt")),
...
func voiceConfigPath() string {
	...
	return expandHome("~/.config/agent-buddy/voice.env")
}
