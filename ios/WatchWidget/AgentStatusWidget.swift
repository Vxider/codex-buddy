...
struct AgentStatusWidgetEntryView: View {
...
struct AgentStatusWidget: Widget {
    var body: some WidgetConfiguration {
        StaticConfiguration(kind: "AgentStatusWidget", provider: AgentStatusProvider()) { entry in
            AgentStatusWidgetEntryView(entry: entry)
                .widgetURL(URL(string: "agentbuddy://sessions"))
        }
        .configurationDisplayName("Agent Status")
        .description("Shows the Agent Buddy icon.")
